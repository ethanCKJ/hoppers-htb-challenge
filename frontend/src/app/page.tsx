...
export default function Home() {
  ...
  const [chatOpen, setChatOpen] = useState(false); // ✅ Chat interface state
  ...
  return (
    <main className="min-h-screen min-w-screen flex flex-col">
      <HeadBar onChatOpen={() => setChatOpen(true)} />
      <div className="flex flex-row flex-1 bg-gray-50 overflow-hidden">
